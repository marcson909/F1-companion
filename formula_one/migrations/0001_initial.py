...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('league', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formula_one.league')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(auto_now_add=True)),
                ('drivers', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='driver_teams', to='formula_one.driver')),
